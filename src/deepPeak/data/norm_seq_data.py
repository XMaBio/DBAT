...
def compute_genomewide_stats(bw_path, label, chroms=None):
    """
    Compute genome-wide statistics using
    log2(1+value) transformation from bigWig
    """
    all_values = []
